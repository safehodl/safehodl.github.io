...
- Tether is only a small part of the on-ramps that allow users to buy Bitcoin.  Bitcoin does not require Tether printing to function anymore than it requires central bank printing in order to function.
