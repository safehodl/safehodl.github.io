...
- There is no known quantum algorithm to break SHA256 cryptography that Bitcoin uses for mining and protects addresses that haven’t revealed their public key.
...
- Most other currencies have lost significant value compared to Bitcoin over time.
